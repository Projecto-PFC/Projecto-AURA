...
async function atualizarDisciplina(id, formData) {
    try {
        ...
        const disciplina = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Service$2f$Disciplinas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["disciplinaService"].atualizar(id, validatedData);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/disciplinas');
        return {
            success: true,
            data: disciplina,
...
async function apagarDisciplina(id) {
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$Service$2f$Disciplinas$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["disciplinaService"].apagar(id);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/disciplinas');
        return {
            success: true,
            data: result,
...
//# sourceMappingURL=_1d3962b1._.js.map